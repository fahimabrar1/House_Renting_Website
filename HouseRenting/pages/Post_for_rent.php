                                    ...
                                    <div class="tab-pane active" id="for-rent" role="tabpanel" aria-labelledby="rent-tab">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 form-group">
                                                <select name="alltypes_pfr" id="" class="form-control w-100">
                                            ...
                                            <div class="col-md-4 form-group">
                                                <select name="anybedrom_pfr" id="" class="form-control w-100">
                                            ...
                                            <div class="col-md-4 form-group">
                                                <select name="anybathroom_pfr" id="" class="form-control w-100">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 form-group">
                                                <input name="sqft_pfr" type="text" class="form-control" placeholder="Sq Ft.">
                                            </div>

                                            <div class="col-md-4 form-group">
                                                <input name="price_pfr" type="text" class="form-control" placeholder="price">
                                            </div>
                                            <div class="col-md-4 form-group">
                                                <input name="title_pfr" type="text" class="form-control" placeholder="Title">
                                            </div>
                                        </div>
                                        <div class="row">

                                            <div class="col-md-4 form-group">
                                                <input name="area_pfr" type="text" class="form-control" placeholder="Area">
                                            </div>
                                            <div class="col-md-4 form-group">
                                                <input name="streetname_pfr" type="text" class="form-control" placeholder="streetname">
                                            </div>
                                            <div class="col-md-4 form-group">
                                                <input name="postcode_pfr" type="text" class="form-control" placeholder="postalcode">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4 form-group">
                                                <input name="road_pfr" type="text" class="form-control" placeholder="Road No.">
                                            </div>
                                            <div class="col-md-4 form-group">
                                                <input name="city_pfr" type="text" class="form-control" placeholder="City">
                                            </div>
                                            <div class="col-md-4 form-group">
                                                <input name="thana_pfr" type="text" class="form-control" placeholder="thana">
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-2 form-group mt-2">
                                                <input name="submit_pfr" type="submit" class="btn btn-danger py-3 btn-block" value="Submit">
                                            </div>
                                        </div>
                                    </div>
                                </div>
